...
export async function fight(firstFighter, secondFighter) {
  let fFighter = (({health, defense}) => ({health, defense}))(firstFighter);
  let sFighter = (({health, defense}) => ({health, defense}))(secondFighter);
  fFighter.id = 1;
  sFighter.id = 2;
  fFighter.attack = firstFighter.power;
  sFighter.attack = secondFighter.power;
  console.log(firstFighter);
  console.log(fFighter);
  console.log(secondFighter);
  console.log(sFighter);
